...
resource "aws_vpc" "main" {
  ...
  tags = {
    blueprint = "KYC Anomaly Detector to reduce fraud loss"
    environment = "production"
    Name = "agentbridge-kyc-anomaly-detector-to-reduce-fraud-los"
    Environment = "production"
    ManagedBy = "terraform"
  }
}
...
resource "aws_internet_gateway" "main" {
  ...
  tags = {
    Name = "agentbridge-kyc-anomaly-detector-to-reduce-fraud-los-igw"
  }
}
...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "agentbridge-kyc-anomaly-detector-to-reduce-fraud-los-public"
  }
}
...
resource "aws_route_table" "public" {
  ...
  tags = {
    Name = "agentbridge-kyc-anomaly-detector-to-reduce-fraud-los-rt"
  }
}
...
resource "aws_security_group" "main" {
  name_prefix = "agentbridge-kyc-anomaly-detector-to-reduce-fraud-los-"
  vpc_id      = aws_vpc.main.id
  ...
  tags = {
    Name = "agentbridge-kyc-anomaly-detector-to-reduce-fraud-los-sg"
  }
...
resource "aws_key_pair" "deploy" {
  ...
  key_name   = "agentbridge-kyc-anomaly-detector-to-reduce-fraud-los"
...
resource "aws_eip" "main" {
  ...
  domain   = "vpc"
  tags = {
    Name = "agentbridge-kyc-anomaly-detector-to-reduce-fraud-los-eip"
  }
}
...
resource "aws_ebs_volume" "data" {
  ...
  encrypted         = true
  tags = {
    Name = "agentbridge-kyc-anomaly-detector-to-reduce-fraud-los-data"
  }
}
...
resource "aws_iam_role" "bedrock_flow" {
  ...
  name  = "agentbridge-kyc-anomaly-detector-to-reduce-fraud-los-bedrock-role"
...
resource "aws_iam_role" "ec2_bedrock" {
  count = var.enable_bedrock ? 1 : 0
  name  = "agentbridge-kyc-anomaly-detector-to-reduce-fraud-los-ec2-bedrock"
...
resource "aws_iam_instance_profile" "ec2_bedrock" {
  count = var.enable_bedrock ? 1 : 0
  name  = "agentbridge-kyc-anomaly-detector-to-reduce-fraud-los-ec2-profile"
...
resource "aws_bedrockagent_flow" "main" {
  count              = var.enable_bedrock ? 1 : 0
  name               = "agentbridge-kyc-anomaly-detector-to-reduce-fraud-los-flow"
